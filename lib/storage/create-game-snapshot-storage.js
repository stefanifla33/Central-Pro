...
function createConfiguredGameSnapshotStorage(options = {}) {
    ...
    const maxDates = Math.max(1, Number(environment.GAME_SNAPSHOT_MAX_DATES) || 5);
    return createGameSnapshotStorage(createLocalGameSnapshotAdapter(file, { ...options.localOptions, maxDates }));
}
