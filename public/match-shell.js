(function(){
  ...
  const sidebar=document.createElement('aside');sidebar.className='sidebar';sidebar.id='sidebar';sidebar.innerHTML='<a class="brand" href="index.html"><span class="brand-mark">CP</span><span>CENTRAL <b>PRO</b><small>SPORTS INTELLIGENCE</small></span></a><nav class="main-nav match-main-nav"><small class="shell-nav-label">PRINCIPAL</small><a href="index.html"><span>⌂</span>Dashboard</a><small class="shell-nav-label">PARTIDAS</small><a href="index.html#live"><span>◉</span>Ao vivo</a><a href="index.html#upcoming"><span>◷</span>Próximas</a><a class="active" href="#overview" data-match-tab="overview"><span>▣</span>Detalhes da partida</a><small class="shell-nav-label">ANÁLISE</small><a href="#stats" data-match-tab="stats"><span>≡</span>Estatísticas</a><a href="#lineups" data-match-tab="lineups"><span>♟</span>Escalações</a></nav><div class="api-state match-api-state"><small>API Status</small><span><i></i><b>Online</b></span><em>Dados protegidos no servidor</em><time>Última atualização: '+new Date().toLocaleTimeString('pt-BR',{hour:'2-digit',minute:'2-digit'})+'</time></div>';
  const frame=document.createElement('div');frame.className='app-frame';
  const header=document.createElement('header');header.className='app-header';header.innerHTML='<label class="global-search"><span>⌕</span><input id="globalSearch" placeholder="Buscar time, jogador, campeonato..." autocomplete="off"><kbd>Ctrl K</kbd></label><div class="header-actions"><a class="match-context-link" href="games.html">← Todos os jogos</a><span class="header-avatar">S</span></div>';
