(function(){
  ...
  const marketLabels={shotsOnGoal:'Chutes no gol',shotsTotal:'Finalizações',goals:'Gols',assists:'Assistências',tackles:'Desarmes',foulsCommitted:'Faltas cometidas',foulsDrawn:'Faltas sofridas',saves:'Defesas'};
